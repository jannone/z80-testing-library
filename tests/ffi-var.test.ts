...
describe('ffi.var', () => {
  ...
  describe('u16', () => {
    it('reads a word (little-endian)', () => {
      ...
      const v = ffi.var(RAM_BASE, 'u16')(m)
  ...
  describe('i16', () => {
    it('reads positive values', () => {
      ...
      const v = ffi.var(RAM_BASE, 'i16')(m)
  ...
  describe('schema reuse', () => {
    it('same schema can bind to different machines', () => {
      ...
      expect(schema(m1).get()).toBe(10)
      expect(schema(m2).get()).toBe(20)
    })
  })

  describe('addr property', () => {
    it('exposes the memory address', () => {
      const m = createMachine()
      const v = ffi.var(0xC000, 'u8')(m)
